...
// Seta mais grossa e conectada com as pontas
    ...
    return (
        <section className="max-w-[1440px] p-5 mx-auto">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <div className="text-primary bg-[#E1D6FE] w-fit py-[5px] px-[8px] rounded-[10px] font-bold text-xs sm:text-sm mb-4 sm:mb-5">
                    {data.top}
                </div>

                <h2 className="font-bold text-2xl sm:text-3xl lg:text-4xl w-[90%] sm:w-full">
                    {renderHighlightedText(data.title)}
                </h2>
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0 text-left">
                            <div className="flex items-baseline gap-2 flex-wrap">
                                <h5 className="text-primary font-bold text-lg sm:text-xl shrink-0">
                                    {card.number}
                                </h5>
                    ...
                    <div key={index} className="flex items-center">
                        ...
                        >
                            ...
                            <div className="text-left w-full flex flex-col flex-1 min-h-0">
                                ...
                                <h5
                                    style={{ color: hexToRgba(card.colour, 1) }}
                                    className="font-bold text-4xl mb-1"
                                >
                                    {card.number}
                                </h5>

                                <h4 className="font-semibold text-2xl leading-tight overflow-hidden h-[3.5rem]">
                                    {card.title}
                                </h4>

                                <div
                                    style={{ backgroundColor: hexToRgba(card.colour, 1) }}
                                    className="w-8 h-1 my-5 rounded-[10px] shrink-0"
                                />

                                <p className="text-xl overflow-hidden line-clamp-4">
                                    {card.p}
                                </p>
            ...
            <div className="lg:hidden w-full min-h-45 flex flex-col bg-card-bg shadow-[0_2px_8px_0_rgba(0,0,0,0.35)] rounded-[10px] border border-primary overflow-hidden">
                ...
                <div className="flex flex-col gap-4 p-5">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className="text-lg sm:text-2xl text-primary font-bold flex-1">
                            {data.bottom.title}
                        </h3>
            ...
            <div className="hidden lg:flex w-full min-h-45 items-stretch gap-6 bg-card-bg shadow-[0_2px_8px_0_rgba(0,0,0,0.35)] rounded-[10px] border border-primary overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 p-5 sm:pl-10 lg:pl-20 sm:py-10 flex-1">
                    ...
                    <div className="flex flex-col flex-1 text-center md:text-left">
                        ...
                        <p className="w-full lg:w-[90%] text-base sm:text-lg mt-3 sm:mt-5">
                            {data.bottom.p}
                        </p>
